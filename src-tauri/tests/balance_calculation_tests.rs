...
fn test_bug_demonstration_old_vs_new_logic() {
    ...
    let old_final_balance = match original_type {
        // BUG: Using original_type instead of new_type
    ...
    let new_final_balance = match new_type {
        // FIXED: Using new_type
    ...
    assert_eq!(
        old_final_balance - new_final_balance,
        Decimal::new(40000, 2)
    ); // $400 difference
}
